...
//fungsi menuimpan data
        loadData();

//fungsi recycle view
        buildRecyclerView();

//fungsi menghitung operasi
        setInsertButton();

//deklarasi variabel dari main xml
...
//fungsi ketika dklik radio botun terisi/check lalu akan muncul text operasi
...
//fungsi ketika memilih yang mana yang di check akan tampil ke recycle view
        String operasi = "";
        if(tambah.isChecked()){
            operasi = "+";
        } else if(kurang.isChecked()){
...
//fungsi untuk menampilkan teks ke recycle view
        if(number1.isEmpty()){
...
//fungsi otomatis menyimpan data
...
//fungsi menyimpan data operasi yang sudah dihitung
